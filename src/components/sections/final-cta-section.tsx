...
export async function FinalCtaSection() {
  ...
  return (
    <section aria-labelledby="final-cta-heading" className="section-pad">
      <Container>
        <Reveal>
          <div className="relative overflow-hidden rounded-[var(--radius-xl)] bg-primary px-6 py-10 text-primary-foreground shadow-[var(--shadow-md)] transition-shadow duration-200 hover:shadow-[var(--shadow-lg)] sm:px-10 sm:py-12 lg:px-14 lg:py-14">
            <div
              aria-hidden
            ...
            <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
              <h2
                ...
                className="text-balance text-2xl font-semibold tracking-tight sm:text-3xl lg:text-[2.15rem]"
              >
                {t("title")}
              </h2>
